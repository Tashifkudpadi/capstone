...
export function Hero() {
  ...
  return (
    <section ref={ref} className="pt-32 pb-20 lg:pt-40 lg:pb-32 relative">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <p className="text-lg text-muted leading-relaxed max-w-xl">
                ...
                modern enterprises for a smarter digital future.
              </p>
            </div>
            ...
            <p
              className={`text-xs text-muted transition-all duration-700 ${
                isVisible ? "opacity-100" : "opacity-0"
              }`}
              style={{ transitionDelay: "600ms" }}
            >
              Independently curated CIO awards & high-impact Confex program for
              Riyadh's digital leadership community.
            </p>
          </div>
          ...
          >
            ...
            <div className="relative bg-panel border border-border-soft rounded-2xl p-8 space-y-6 hover:border-accent-green/40 transition-all duration-500">
              ...
              <p className="text-muted leading-relaxed">
                ...
                leaders who are driving AI innovation, data intelligence, cloud
                modernization, cyber resilience and LCNC-powered automation
